...
mongo kenwiley --eval "db.users.save({'name':'foo', 'email':'foo@gmail.com', 'hash' : '\$2a\$10\$rMNFo1LEUYnKCcBAwMO23u4Az7tgm1fanK77X\/2TLsSxO1wr3M7Za', 'salt' : '\$2a\$10\$rMNFo1LEUYnKCcBAwMO23u'})"
