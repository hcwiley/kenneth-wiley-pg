...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectAsset.image'
        db.alter_column(u'oil_gas_project_projectasset', 'image', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectAsset.image'
        db.alter_column(u'oil_gas_project_projectasset', 'image', self.gf('django.db.models.fields.CharField')(max_length=255))
