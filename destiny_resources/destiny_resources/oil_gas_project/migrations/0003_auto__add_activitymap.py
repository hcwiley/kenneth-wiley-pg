...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityMap'
        db.create_table(u'oil_gas_project_activitymap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'oil_gas_project', ['ActivityMap'])


    def backwards(self, orm):
        # Deleting model 'ActivityMap'
        db.delete_table(u'oil_gas_project_activitymap')
